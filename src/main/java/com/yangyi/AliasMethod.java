...
public class AliasMethod {
    ...
    /**
     * Constructs a new AliasMethod to sample from a discrete distribution and hand back outcomes based on the
     ...
     * probability distribution.
     * <p/>
     * Given as input a list of probabilities corresponding to outcomes 0, 1, ..., n - 1, along with the random number
     * generator that should be used as the underlying generator, this constructor creates the probability and alias
